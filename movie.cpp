...
Movie::Movie(std::string ti, std::string tr, unsigned int rd, std::string r, bool f, int rt , bool ac, unsigned int ir, unsigned int fp, std::string ca, std::string g, std::string ra):  AudioVisual(ti,tr,rd,r,f,rt,ac,ir,fp), cast(ca), genre(g), rating(ra) {}
